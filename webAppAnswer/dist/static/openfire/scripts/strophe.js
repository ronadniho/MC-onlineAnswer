...
// Base64E code from Tyler Akins -- http://rumkin.com

(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('strophe-Base64E', function () {
            return factory();
        });
    } else {
        // Browser globals
        root.Base64E = factory();
    }
}(this, function () {
    ...
    var obj = {
        /**
         * Encodes a string in Base64E
         * @param {String} input The string to encode in Base64E.
         */
...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        // Browser globals
        var o = factory(root.SHA1, root.Base64E, root.MD5, root.stropheUtils);
...
}(this, function (SHA1, Base64E, MD5, utils) {
...
Strophe.Connection.prototype = {
    ...
    */
    ...
    _attemptSASLAuth: function (mechanisms) {
        ...
        for (i = 0; i < mechanisms.length; ++i) {
            ...
            if (this._sasl_mechanism.isClientFirst) {
                ...
                request_auth_exchange.t(Base64E.encode(response));
            }
    ...
    _sasl_challenge_cb: function(elem) {
      var challenge = Base64E.decode(Strophe.getText(elem));
      var response = this._sasl_mechanism.onChallenge(this, challenge);
      var stanza = $build('response', {
          'xmlns': Strophe.NS.SASL
      });
      if (response !== "") {
        stanza.t(Base64E.encode(response));
      }
    ...
    _sasl_success_cb: function (elem) {
        if (this._sasl_data["server-signature"]) {
            var serverSignature;
            var success = Base64E.decode(Strophe.getText(elem));
            var attribMatch = /([a-z]+)=([^,]+)(,|$)/;
...
Strophe.SASLSHA1.prototype.onChallenge = function(connection, challenge, test_cnonce) {
  ...
  this.onChallenge = function (connection, challenge) {
    ...
    responseText += ",p=" + Base64E.encode(SHA1.binb2str(clientKey));
    return responseText;
  }.bind(this);
